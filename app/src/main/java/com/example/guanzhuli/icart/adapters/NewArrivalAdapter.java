...
public class NewArrivalAdapter extends RecyclerView.Adapter<NewArrivalHolder>{
    ...
    private void initialList() {
        int[] itemId = {123,321,333,232,452,167,200};
        String[] name = {"Heel Shoes", "Tablet", "SamSung", "Laptop", "Handbag","Watch","Sunglasses"};
        Double[] price = {90.99, 200.00, 400.00, 900.99, 70.39,100.00,75.00};
        int[] res = {R.drawable.item1, R.drawable.item2, R.drawable.item3, R.drawable.item4, R.drawable.item5,R.drawable.item6,R.drawable.item7};
